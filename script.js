...
const productDetail = document.querySelector('.product-detailTwo');
const buttonClose = document.querySelector('.product-detail-closeTwo')
...
function renderProduct(arr) {
    ...
    for(product of arr) {
        ...
        img.addEventListener('click',toggleProductDetails)
