...
navEmail.addEventListener("click", () => {toggleMenu(desktopMenu); carritoComprasDesplegable.classList.add("inactive")});

// Evento de click con el menu mobile
burguerMenu.addEventListener("click", () => {toggleMenu(mobileMenu); carritoComprasDesplegable.classList.add("inactive")});

//Evento de click al carrito de compras
carritoCompras.addEventListener("click", () => {toggleMenu(carritoComprasDesplegable); desktopMenu.classList.add("inactive"); mobileMenu.classList.add("inactive")});
...
function renderProduct(arr){
	...
	const productCards = `
		<div class="product-card">
	        <img src="${product.imagen}" alt="Articulo de bicicleta">
